/**
 * Per-model depreciation profiles compiled from:
 * - iSeeCars 2024 depreciation study (https://www.iseecars.com/car-depreciation)
 * - CarEdge 2024 5-year cost-to-own data
 * - Edmunds TCO (True Cost to Own) multi-year data
 * - CarGurus regional price analysis
 *
 * fiveYear:  fraction of original MSRP RETAINED after 5 years (e.g. 0.65 = keeps 65%)
 * tenYear:   fraction of original MSRP RETAINED after 10 years
 * mileagePenaltyPer1k: dollar value lost per 1,000 miles above average (class-specific)
 *
 * Depreciation curve (0–5 years) uses front-loading weights based on real observed
 * patterns: ~48% of the 5-year drop happens in year 1, 25% in year 2, etc.
 * Years 5–10: linear interpolation between fiveYear and tenYear endpoints.
 * Years 10+: slower tail-off with a floor so value never hits zero.
 */
...
export function retentionAtYear(profile: DepreciationProfile, ageYears: number): number {
  ...
  if (ageYears <= 10) {
    // Linear interpolation between fiveYear and tenYear
    const t = (ageYears - 5) / 5;
    return Math.max(0.05, profile.fiveYear + (profile.tenYear - profile.fiveYear) * t);
  }

  // Years 10+: continue at ~half the year-5-to-10 annual rate, with a floor
  const annualRate = (profile.fiveYear - profile.tenYear) / 5;
  const extraYears = ageYears - 10;
  return Math.max(0.05, profile.tenYear - annualRate * 0.5 * extraYears);
}
...
const PROFILES: Record<string, DepreciationProfile> = {
  ...
  "ford|maverick":            { fiveYear: 0.72, tenYear: 0.46, mileagePenaltyPer1k: 50 },
  "ford|ranger":              { fiveYear: 0.68, tenYear: 0.43, mileagePenaltyPer1k: 50 },
  "ford|expedition":          { fiveYear: 0.65, tenYear: 0.40, mileagePenaltyPer1k: 55 },
  "chevrolet|silverado":      { fiveYear: 0.72, tenYear: 0.46, mileagePenaltyPer1k: 52 },
  "chevrolet|silverado 1500": { fiveYear: 0.72, tenYear: 0.46, mileagePenaltyPer1k: 52 },
  "chevrolet|tahoe":          { fiveYear: 0.72, tenYear: 0.48, mileagePenaltyPer1k: 55 },
  "chevrolet|suburban":       { fiveYear: 0.72, tenYear: 0.48, mileagePenaltyPer1k: 55 },
  "chevrolet|colorado":       { fiveYear: 0.65, tenYear: 0.40, mileagePenaltyPer1k: 50 },
  "gmc|sierra":               { fiveYear: 0.74, tenYear: 0.48, mileagePenaltyPer1k: 52 },
  "gmc|sierra 1500":          { fiveYear: 0.74, tenYear: 0.48, mileagePenaltyPer1k: 52 },
  "gmc|yukon":                { fiveYear: 0.73, tenYear: 0.49, mileagePenaltyPer1k: 55 },
  "gmc|yukon xl":             { fiveYear: 0.73, tenYear: 0.49, mileagePenaltyPer1k: 55 },
  "gmc|canyon":               { fiveYear: 0.64, tenYear: 0.38, mileagePenaltyPer1k: 50 },
  "ram|1500":                 { fiveYear: 0.73, tenYear: 0.48, mileagePenaltyPer1k: 52 },
  "ram|2500":                 { fiveYear: 0.71, tenYear: 0.46, mileagePenaltyPer1k: 52 },
  "ram|3500":                 { fiveYear: 0.71, tenYear: 0.46, mileagePenaltyPer1k: 52 },
  "honda|ridgeline":          { fiveYear: 0.66, tenYear: 0.40, mileagePenaltyPer1k: 52 },
  "nissan|frontier":          { fiveYear: 0.67, tenYear: 0.42, mileagePenaltyPer1k: 50 },
  "nissan|titan":             { fiveYear: 0.60, tenYear: 0.36, mileagePenaltyPer1k: 50 },

  // ── RELIABLE JAPANESE / KOREAN SUVs & sedans ──────────────────────────────
  "toyota|camry":             { fiveYear: 0.64, tenYear: 0.38, mileagePenaltyPer1k: 50 },
  "toyota|camry hybrid":      { fiveYear: 0.60, tenYear: 0.35, mileagePenaltyPer1k: 48 },
  "toyota|corolla":           { fiveYear: 0.62, tenYear: 0.36, mileagePenaltyPer1k: 48 },
  "toyota|corolla hybrid":    { fiveYear: 0.60, tenYear: 0.34, mileagePenaltyPer1k: 46 },
  "toyota|rav4":              { fiveYear: 0.63, tenYear: 0.38, mileagePenaltyPer1k: 52 },
  "toyota|rav4 hybrid":       { fiveYear: 0.65, tenYear: 0.40, mileagePenaltyPer1k: 50 },
  "toyota|rav4 prime":        { fiveYear: 0.66, tenYear: 0.42, mileagePenaltyPer1k: 50 },
  "toyota|highlander":        { fiveYear: 0.65, tenYear: 0.40, mileagePenaltyPer1k: 52 },
  "toyota|highlander hybrid": { fiveYear: 0.66, tenYear: 0.42, mileagePenaltyPer1k: 50 },
  "toyota|prius":             { fiveYear: 0.57, tenYear: 0.32, mileagePenaltyPer1k: 44 },
  ...
  "honda|hrv":                { fiveYear: 0.60, tenYear: 0.36, mileagePenaltyPer1k: 50 },
  ...
  "bmw|3 series":             { fiveYear: 0.48, tenYear: 0.22, mileagePenaltyPer1k: 75 },
  "bmw|4 series":             { fiveYear: 0.47, tenYear: 0.21, mileagePenaltyPer1k: 75 },
  "bmw|5 series":             { fiveYear: 0.45, tenYear: 0.20, mileagePenaltyPer1k: 80 },
  "bmw|7 series":             { fiveYear: 0.38, tenYear: 0.16, mileagePenaltyPer1k: 90 },
  "bmw|x1":                   { fiveYear: 0.50, tenYear: 0.24, mileagePenaltyPer1k: 70 },
  ...
  "mercedes-benz|s-class":    { fiveYear: 0.38, tenYear: 0.15, mileagePenaltyPer1k: 95 },
  "mercedes-benz|cla":        { fiveYear: 0.47, tenYear: 0.21, mileagePenaltyPer1k: 72 },
  "mercedes-benz|glb":        { fiveYear: 0.49, tenYear: 0.23, mileagePenaltyPer1k: 72 },
  ...
  "audi|q3":                  { fiveYear: 0.51, tenYear: 0.25, mileagePenaltyPer1k: 70 },
  "audi|q5":                  { fiveYear: 0.52, tenYear: 0.26, mileagePenaltyPer1k: 75 },
  ...
  "lexus|is":                 { fiveYear: 0.55, tenYear: 0.30, mileagePenaltyPer1k: 65 },
  "lexus|rx":                 { fiveYear: 0.58, tenYear: 0.34, mileagePenaltyPer1k: 65 },
  "lexus|nx":                 { fiveYear: 0.57, tenYear: 0.33, mileagePenaltyPer1k: 65 },
  ...
  "infiniti|q50":             { fiveYear: 0.46, tenYear: 0.21, mileagePenaltyPer1k: 68 },
  "infiniti|qx50":            { fiveYear: 0.46, tenYear: 0.20, mileagePenaltyPer1k: 65 },
  "infiniti|qx60":            { fiveYear: 0.47, tenYear: 0.22, mileagePenaltyPer1k: 67 },
  "infiniti|qx80":            { fiveYear: 0.50, tenYear: 0.25, mileagePenaltyPer1k: 70 },
  "genesis|g70":              { fiveYear: 0.48, tenYear: 0.22, mileagePenaltyPer1k: 68 },
  ...
  // Ferrari mileage penalty is high because low-mileage examples command a
  // significant premium in the exotic market (~$100-150 per 1k miles delta).
  // Combined with exotic weight (0.65) = ~$65-100/1k effective rate.
  "ferrari|488":              { fiveYear: 0.84, tenYear: 0.72, mileagePenaltyPer1k: 150, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|488 gtb":          { fiveYear: 0.84, tenYear: 0.72, mileagePenaltyPer1k: 150, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|488 spider":       { fiveYear: 0.86, tenYear: 0.74, mileagePenaltyPer1k: 140, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|488 pista":        { fiveYear: 0.95, tenYear: 0.85, mileagePenaltyPer1k: 120, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|488 pista spider": { fiveYear: 0.98, tenYear: 0.90, mileagePenaltyPer1k: 110, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|f8 tributo":       { fiveYear: 0.88, tenYear: 0.76, mileagePenaltyPer1k: 140, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|f8 spider":        { fiveYear: 0.90, tenYear: 0.78, mileagePenaltyPer1k: 130, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|roma":             { fiveYear: 0.82, tenYear: 0.68, mileagePenaltyPer1k: 130, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|portofino":        { fiveYear: 0.78, tenYear: 0.62, mileagePenaltyPer1k: 120, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|portofino m":      { fiveYear: 0.80, tenYear: 0.65, mileagePenaltyPer1k: 125, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|sf90":             { fiveYear: 1.00, tenYear: 0.90, mileagePenaltyPer1k: 100, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|sf90 stradale":    { fiveYear: 1.00, tenYear: 0.90, mileagePenaltyPer1k: 100, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|sf90 spider":      { fiveYear: 1.05, tenYear: 0.95, mileagePenaltyPer1k: 95,  yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|812":              { fiveYear: 0.86, tenYear: 0.74, mileagePenaltyPer1k: 140, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|812 superfast":    { fiveYear: 0.86, tenYear: 0.74, mileagePenaltyPer1k: 140, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|812 gts":          { fiveYear: 0.90, tenYear: 0.78, mileagePenaltyPer1k: 130, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|812 competizione": { fiveYear: 1.10, tenYear: 1.00, mileagePenaltyPer1k: 100, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|purosangue":       { fiveYear: 0.92, tenYear: 0.80, mileagePenaltyPer1k: 120, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
  "ferrari|296 gtb":          { fiveYear: 0.88, tenYear: 0.76, mileagePenaltyPer1k: 130, yearWeights: YEAR_WEIGHTS_ENTHUSIAST },
...
const CLASS_DEFAULTS: Record<string, DepreciationProfile> = {
  luxury_german: { fiveYear: 0.48, tenYear: 0.22, mileagePenaltyPer1k: 76 },
  luxury_other:  { fiveYear: 0.53, tenYear: 0.27, mileagePenaltyPer1k: 68 },
...
// State two-letter code → price multiplier vs. national average.
// Based on CarGurus regional data and MarketCheck state-level analysis.
...
const STATE_MULTIPLIERS: Record<string, number> = {
  ...
  MD: 0.98, GA: 0.97, TX: 0.97, NC: 0.96,              // Large supply markets
  IL: 0.96, TN: 0.95, PA: 0.95, ID: 0.95, SC: 0.95,   // Mid-tier markets
  MN: 0.94, WI: 0.94, MO: 0.94, KY: 0.93,             // Colder/inland markets
  OH: 0.93, NE: 0.92, IN: 0.92, AL: 0.92, LA: 0.92,   // Rust-adjacent
  MI: 0.91, KS: 0.91, MT: 0.91, WV: 0.90,              // High supply / rural
  OK: 0.90, ND: 0.90, SD: 0.90, AR: 0.89, MS: 0.88,   // Lowest cost markets
  NM: 0.93, WY: 0.91, IA: 0.92, ME: 0.97, NH: 1.00, VT: 0.98,
  DE: 1.00, RI: 1.01,
};

// ZIP prefix (first 3 digits) → 2-letter state code
// Covers all US states; groups of ZIP prefixes per state.
const ZIP_TO_STATE: Record<string, string> = {
  ...
  "780": "TX","781": "TX","782": "TX","783": "TX","784": "TX","785": "TX","786": "TX","787": "TX","788": "TX",
  "789": "TX","790": "TX","791": "TX","792": "TX","793": "TX","794": "TX","795": "TX","796": "TX","797": "TX","798": "TX","799": "TX",
...
export function getGeoMultiplier(zipCode: string): number {
