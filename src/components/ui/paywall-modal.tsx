              ...
              <div className="space-y-2 mb-5">
                {FOUNDER_PERKS.map((v) => (
                  <div key={v} className="flex items-center gap-2.5 text-sm px-3 py-2 rounded-xl"
                    ...
                    <svg viewBox="0 0 24 24" fill="none" stroke="#818cf8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5 flex-shrink-0" aria-hidden="true">
